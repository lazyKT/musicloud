    ...
    <>
      <div className="mainDiv">
        ...
        {/* <form className="authForm" onSubmit={onSubmitHandler}>
          ...
          />
          {usernameerror && (
            <img style={valid_icon} src={Error} alt="Credit to Flaticon" />
          )}
          {!usernameerror && username ? (
            <img style={valid_icon} src={Tick} alt="Credit to Flaticon" />
          ) : null}
          {usernameerror && (
          ...
          {pwderror && (
            <span style={{ color: "red" }}>
              Password should have at least 8 charactors, 1 uppercase letter, 1
          ...
          <button
            disabled={!ready}
            type="submit"
            style={ready ? null : Register_btn_disable}
          >
            Register
          </button> */}
        {/* message of results */}
